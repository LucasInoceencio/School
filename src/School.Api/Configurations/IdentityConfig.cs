...
using School.Identity.PolicyRequirements;
...
public static class IdentityConfig
{
    ...
    {
        services.AddSingleton<IAuthorizationHandler, BussinessHoursHandler>();
        services.AddAuthorization(options =>
        {
            options.AddPolicy(Policies.BussinessHours, policy =>
                policy.Requirements.Add(new BussinessHoursRequirement()));
        });
    }
}